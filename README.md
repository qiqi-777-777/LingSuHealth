# 灵素健康管理系统 (LingSuHealth)

## 📖 项目简介

灵素健康管理系统是一个基于中医养生理念的智能健康管理平台，结合现代AI技术为用户提供个性化的健康管理方案。系统支持健康打卡、体质评估、节气养生、知识库管理等功能，帮助用户建立科学的健康生活习惯。
...
deepseek:
  api:
    key: ${DEEPSEEK_API_KEY:your_deepseek_api_key_here}
